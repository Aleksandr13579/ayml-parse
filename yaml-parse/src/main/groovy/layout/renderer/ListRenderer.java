...
public class ListRenderer extends BlockRenderer {
     ...
     *
     * @param modelElement the {@link layout.element.List} which this object should manage
     */
    public ListRenderer(layout.element.List modelElement) {
        super(modelElement);
    }
    ...
    public IRenderer getNextRenderer() {
        ...
        return new ListRenderer((layout.element.List) modelElement);
    }
