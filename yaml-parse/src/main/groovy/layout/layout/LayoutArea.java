...
/**
 * Represents the area for content {@link IRenderer#layout(LayoutContext) layouting}.
 */
public class LayoutArea implements Cloneable {
    ...
    /**
     * Creates the area for content {@link IRenderer#layout(LayoutContext) layouting}.
     *
