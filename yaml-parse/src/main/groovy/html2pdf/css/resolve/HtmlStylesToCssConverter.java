...
class HtmlStylesToCssConverter {
    ...
    private static class BorderAttributeConverter implements IAttributeConverter {
        ...
        /* (non-Javadoc)
         * @see html2pdf.css.resolve.HtmlStylesToCssConverter.IAttributeConverter#isSupportedForElement(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see html2pdf.css.resolve.HtmlStylesToCssConverter.IAttributeConverter#convert(styledxmlparser.html.node.IElementNode, java.lang.String)
         */
        @Override
