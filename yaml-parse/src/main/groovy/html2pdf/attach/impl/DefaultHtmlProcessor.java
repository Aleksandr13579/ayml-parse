...
import html2pdf.actions.events.PdfHtmlProductEvent;
...
import html2pdf.attach.impl.layout.RunningElementContainer;
import html2pdf.attach.impl.tags.HtmlTagWorker;
import html2pdf.attach.impl.tags.RunningElementTagWorker;
import html2pdf.attach.util.LinkHelper;
import html2pdf.css.CssConstants;
import html2pdf.css.apply.ICssApplier;
import html2pdf.css.apply.util.TextDecorationApplierUtil;
import html2pdf.css.resolve.DefaultCssResolver;
...
import html2pdf.attach.IHtmlProcessor;
import html2pdf.css.apply.util.CounterProcessorUtil;
import html2pdf.css.apply.util.PageBreakApplierUtil;
...
public class DefaultHtmlProcessor implements IHtmlProcessor {
    ...
    public List<IElement> processElements(INode root) {
        ...
        for (IPropertyContainer propertyContainer : bodyDiv.getChildren()) {
            if (propertyContainer instanceof IElement) {
