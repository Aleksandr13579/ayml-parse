 ...
 */
package styledxmlparser.jsoup.select;

import com.itextpdf.commons.utils.MessageFormatUtil;
import styledxmlparser.jsoup.helper.Validate;
import styledxmlparser.jsoup.internal.Normalizer;
import styledxmlparser.jsoup.nodes.*;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<styledxmlparser.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (styledxmlparser.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    styledxmlparser.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
