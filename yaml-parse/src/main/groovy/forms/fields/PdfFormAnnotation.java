...
import forms.fields.borders.FormBorderFactory;
import forms.fields.properties.CheckBoxType;
import forms.form.FormProperty;
import forms.form.element.*;
import forms.form.renderer.checkboximpl.PdfCheckBoxRenderingStrategy;
import forms.logs.FormsLogMessageConstants;
import forms.util.FontSizeUtil;
...
/**
 * This class represents a single annotation in form fields hierarchy in an {@link PdfAcroForm
 * AcroForm}.
 *
 * <p>
