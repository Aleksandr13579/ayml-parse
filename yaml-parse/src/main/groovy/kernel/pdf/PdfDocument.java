...
import kernel.pdf.PdfReader.StrictnessLevel;
...
import kernel.font.PdfFontFactory;
import kernel.geom.PageSize;
import kernel.logs.KernelLogMessageConstant;
import kernel.numbering.EnglishAlphabetNumbering;
import kernel.numbering.RomanNumbering;
import kernel.pdf.annot.PdfAnnotation;
import kernel.pdf.annot.PdfWidgetAnnotation;
import kernel.pdf.canvas.CanvasGraphicsState;
import kernel.pdf.canvas.PdfCanvas;
import kernel.pdf.collection.PdfCollection;
import kernel.pdf.filespec.PdfEncryptedPayloadFileSpecFactory;
import kernel.pdf.filespec.PdfFileSpec;
import kernel.pdf.navigation.PdfDestination;
import kernel.pdf.statistics.NumberOfPagesStatisticsEvent;
import kernel.pdf.statistics.SizeOfPdfStatisticsEvent;
import kernel.pdf.tagging.PdfStructTreeRoot;
import kernel.pdf.tagutils.TagStructureContext;
import kernel.xmp.*;
import kernel.xmp.options.PropertyOptions;
import kernel.xmp.options.SerializeOptions;
