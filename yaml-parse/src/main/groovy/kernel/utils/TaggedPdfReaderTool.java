...
import kernel.pdf.canvas.parser.PdfCanvasProcessor;
import kernel.pdf.canvas.parser.data.IEventData;
import kernel.pdf.canvas.parser.data.TextRenderInfo;
import kernel.pdf.canvas.parser.listener.IEventListener;
import kernel.pdf.canvas.parser.listener.ITextExtractionStrategy;
import kernel.pdf.canvas.parser.listener.LocationTextExtractionStrategy;
...
public class TaggedPdfReaderTool {
    ...
    protected void inspectKid(IStructureNode kid) {
        try {
            ...
            throw new io.exceptions.IOException(IoExceptionMessageConstant.UNKNOWN_IO_EXCEPTION, e);
        }
    }
